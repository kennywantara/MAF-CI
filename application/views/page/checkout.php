			...
			<div class="cart-header<?php echo $data['rowid']; ?>">
				...
				<div class="cart-sec simpleCart_shelfItem">
					    ...
					    <div class="cart-item-info">
						    ...
						    <h3><a href="" onclick="document.getElementById('form<?php echo $data['id']?>').submit();return false;"><?php echo $data['name'];?></a><span><?php echo $data['category']?></span></h3>
							<ul class="qty">		
			 ...
			 <script>$(document).ready(function(c) {
					$('#<?php echo $data['id']; ?>').on('click', function(c){
						deleteproduct('<?php echo $data['rowid']?>');
					});
				})
			 </script>
